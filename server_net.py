...
class prediction_net(nn.Module):
    def __init__(self, w, n_features_input , n_input_caps , n_output_caps , in_caps_dim , out_caps_dim , n_routing = 3, lr=0.01):
        super().__init__()
        ...
        self.layer1 = nn.Linear(w + n_features_input , 32 )
